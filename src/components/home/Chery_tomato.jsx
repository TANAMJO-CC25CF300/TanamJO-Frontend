                ...
                <div className="p-3.5 sm:p-4.5 mx-5 md:mx-15 mt-20 md:mt-20 rounded-3xl border border-gray-200 min-h-[130px]">
                    <div className="text-left space-y-3 sm:space-y-4">
                        <div className="flex flex-col items-start space-y-3 md:space-y-2">    
                            ...
                            <p className="text-sm/6 md:text-sm/6 font-medium leading-normal tracking-wider custome-deskription italic">
                ...
                <div className="p-3.5 sm:p-4.5 mx-5 md:mx-15 mt-8 rounded-3xl border border-gray-200">
                    <div className="text-left space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="p-5 bg-white rounded-2xl border border-gray-200 shadow-sm">
                                ...
                                <p className="text-sm/6 font-medium leading-relaxed tracking-wider custome-deskription text-gray-600">
                    ...
                    <div className="text-left space-y-6 mb-2 mt-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="p-5 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                                ...
                                <p className="text-sm/6 font-medium leading-relaxed tracking-wider custome-deskription text-gray-600 line-clamp-4">Cherry tomatoes require 6-8 hours of direct sunlight daily. Optimal growth occurs at temperatures between 65-85°F (18-29°C). Position plants in a south-facing location with protection from strong afternoon sun in hot climates. Use shade cloth if temperatures exceed 90°F (32°C). Morning sun is particularly important for fruit development and disease prevention.</p>
                            </div>
                            ...
                            <div className="p-5 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                                ...
                                <p className="text-sm/6 font-medium leading-relaxed tracking-wider custome-deskription text-gray-600 line-clamp-4">Use well-draining soil with a pH between 6.0-6.8. Ideal soil composition: 40% garden soil, 30% compost, 20% perlite, and 10% vermiculite. Add 2-3 inches of organic matter (compost or aged manure) before planting. Soil temperature should be at least 60°F (15.5°C) for optimal root development. Test soil pH monthly and adjust as needed using lime (to raise pH) or sulfur (to lower pH).</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-left space-y-6 mb-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="p-6 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
                                <div className="flex items-center space-x-3 mb-4">
                                    <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center">
                                        <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start space-x-3">
                                        ...
                                        <p className="text-sm/6 font-medium leading-relaxed tracking-wider custome-deskription text-gray-600">Aphids: Spray with insecticidal soap (2 tbsp per gallon) every 3-4 days until controlled. Introduce ladybugs as natural predators.</p>
                                    </li>
                                    <li className="flex items-start space-x-3">
                                        <div className="w-2 h-2 mt-2 rounded-full bg-orange-500 flex-shrink-0"></div>
                                        <p className="text-sm/6 font-medium leading-relaxed tracking-wider custome-deskription text-gray-600">Hornworms: Hand-pick daily or apply Bacillus thuringiensis (BT) spray weekly. Use blacklight at night to spot them.</p>
                                    </li>
                                    <li className="flex items-start space-x-3">
                                        <div className="w-2 h-2 mt-2 rounded-full bg-orange-500 flex-shrink-0"></div>
                                        <p className="text-sm/6 font-medium leading-relaxed tracking-wider custome-deskription text-gray-600">Whiteflies: Use yellow sticky traps (1 per 10 square feet) and apply neem oil every 7-10 days. Introduce parasitic wasps.</p>
                                    </li>
                                    <li className="flex items-start space-x-3">
                                        <div className="w-2 h-2 mt-2 rounded-full bg-orange-500 flex-shrink-0"></div>
                                        <p className="text-sm/6 font-medium leading-relaxed tracking-wider custome-deskription text-gray-600">Spider Mites: Spray with water daily and apply miticide if severe. Maintain humidity above 60%.</p>
                                    </li>
                                    <li className="flex items-start space-x-3">
                                        <div className="w-2 h-2 mt-2 rounded-full bg-orange-500 flex-shrink-0"></div>
                                        <p className="text-sm/6 font-medium leading-relaxed tracking-wider custome-deskription text-gray-600">Cutworms: Place collars around seedlings and apply diatomaceous earth. Use cardboard or aluminum foil collars.</p>
                                    </li>
                                    <li className="flex items-start space-x-3">
                                        <div className="w-2 h-2 mt-2 rounded-full bg-orange-500 flex-shrink-0"></div>
                                        <p className="text-sm/6 font-medium leading-relaxed tracking-wider custome-deskription text-gray-600">Slugs: Apply beer traps and diatomaceous earth. Hand-pick at night with flashlight.</p>
                                    </li>
                                </ul>
                            </div>
