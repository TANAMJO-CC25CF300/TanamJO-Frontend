                ...
                <header className="absolute inset-x-0 top-0 z-50">
                    <nav className="flex items-center justify-between p-5 xl:px-8 h-22" aria-label="Global">
                        ...
                        <div className="flex xl:hidden gap-x-5">
                            <button onClick={handleSearchOpen} className="flex items-center justify-center w-10 h-10 text-white bg-white/20 backdrop-blur-sm rounded-full border border-white">
                        ...
                        <div className="hidden xl:flex xl:flex-1 xl:justify-end gap-x-5">
                            <button onClick={handleSearchOpen} className="flex items-center justify-center w-11 h-11 text-white bg-white/20 backdrop-blur-sm rounded-full border border-white">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                                </svg>
                            </button>
