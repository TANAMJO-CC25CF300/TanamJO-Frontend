            ...
            <div className="lg:mx-0 xl:mx-10 -mt-6 w-auto rounded-4xl text-center relative z-20 mb-5 shadow-md pattern-background">
                ...
                <div className="mx-5 md:mx-15 pt-15 sm:pt-15 md:pt-16 lg:pt-18 rounded-3xl">
                    <div className="text-left space-y-3 sm:space-y-4">
                        <div className="flex flex-col items-start space-y-5 md:space-y-8 rounded-3xl group">    
                            ...
                            <div className="space-y-5 md:space-y-6 md:-mt-4">
                                <p className="text-sm/7 md:text-base/7 font-medium leading-relaxed font-nunito tracking-wide text-gray-500 group-hover:text-emerald-600 transition-colors duration-300">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
                            <div className="w-full p-3 border border-gray-300 rounded-3xl text-left group">
                        ...
                        <div className="flex flex-col items-start space-y-5 md:space-y-6 mt-8 group">    
                        ...
                        <div className="w-full max-w-4xl mx-auto custom-banner-artikel rounded-3xl p-4 md:p-5 flex items-center mt-6 group">
                            ...
                            <p className="text-sm/7 md:text-base/7 font-medium leading-relaxed font-nunito tracking-wide text-gray-500 text-left italic group-hover:text-emerald-600 transition-colors duration-300">
