    ...
    const beefsteakData = {
        ...
        plantingGuide: [
            ...
            },
            {
                ...
                description: "Space plants 36-48 inches apart. Rows should be 48-60 inches apart. Install sturdy support structures (cages, stakes, or trellises) at planting time. For staking, use 8-foot stakes and tie plants every 12 inches as they grow.",
        ...
        harvesting: [
            {
                ...
                items: [
                    ...
                    "Expect first harvest 80-90 days after transplanting"
                ]
            },
            {
                title: "Storage",
        ...
        nutrition: [
            {
                ...
                bulletColor: "bg-blue-500",
                items: [
                    "Vitamin C: 28% of daily value per cup",
                    "Vitamin A: 20% of daily value per cup",
                    "Potassium: 10% of daily value per cup",
        ...
        references: [
            ...
            },
            {
                ...
                bulletColor: "bg-purple-500",
                items: [
                    "USDA Agricultural Research Service. (2023). Tomato Breeding and Genetics.",
                    "National Sustainable Agriculture Information Service. (2023). Organic Tomato Production.",
                    "International Plant Nutrition Institute. (2023). Tomato Nutrient Management Guide."
                ]
            }
        ]
    };
...
export default BeefsteakTomato;