  ...
  return (
    <div className="min-h-screen bg-white flex justify-center items-center px-8 py-8">
      <div className="w-full max-w-[1280px] bg-white rounded-3xl overflow-hidden shadow-xl">
        ...
        {/* Optional Custom HarvestLandingHome Section */}
        <div className="lg:mx-0 xl:mx-10 w-auto -mt-0 text-center relative z-20 mb-5 shadow-md pattern-background">
          <HarvestLandingHome />
        </div>
        ...
        <section className="w-full bg-cover py-16">
          <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10 ml-20">
            {[
              { title: "Expert Guidance", desc: "Quick tips from tomato specialists." },
              { title: "Learning Resources", desc: "Easy guides and how-tos." },
              { title: "Community Support", desc: "Ask & share with fellow growers." }
            ].map((item, i) => (
